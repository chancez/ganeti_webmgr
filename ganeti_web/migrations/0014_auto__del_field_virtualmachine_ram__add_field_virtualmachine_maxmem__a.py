...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VirtualMachine.minmem'
        db.add_column('ganeti_web_virtualmachine', 'minmem',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)
       
        # Rename RAM to maxmem
        db.rename_column('ganeti_web_virtualmachine', 'ram', 'maxmem') 

        # Set the Min/Max RAM size both as the old RAM value
        the_data = orm['ganeti_web.virtualmachine']
        for data in the_data.objects.all():
            data.minmem = data.maxmem
            data.save()

    def backwards(self, orm):
        # Rename maxmem to RAM
        db.rename_column('ganeti_web_virtualmachine', 'maxmem', 'ram')

        # Deleting field 'VirtualMachine.maxmem'
        db.delete_column('ganeti_web_virtualmachine', 'maxmem')
    ...
    models = {
        ...
        'ganeti_web.virtualmachine': {
            ...
            'ignore_cache': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_job': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['ganeti_web.Job']"}),
            'maxmem': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'minmem': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'mtime': ('ganeti_web.fields.PreciseDateTimeField', [], {'null': 'True', 'max_digits': '18', 'decimal_places': '6'}),
        ...
        'ganeti_web.virtualmachinetemplate': {
            ...
            'iallocator_hostname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
